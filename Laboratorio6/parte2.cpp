...
int main(int argc, char *argv[]) {
    pthread_t threadsID[NUM_THREADS];  // Arreglo de identificadores de hilos
    ...
    for (t = 0; t < NUM_THREADS; t++) {
         ...
         * Argumentos:
         * 1. &threadsID[t]: referencia al identificador del hilo
    ...
    // Ciclo para realizar el join de los hilos (esperar a que todos los hilos terminen)
    for (t = 0; t < NUM_THREADS; t++) {
        /* 
         * pthread_join: espera a que un hilo termine.
         * Argumentos:
         * 1. threadsID[t]: identificador del hilo que se va a esperar
